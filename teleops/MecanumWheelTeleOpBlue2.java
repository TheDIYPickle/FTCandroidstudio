...
@TeleOp(name="MecanumWheelTeleOpBlue2")
public class MecanumWheelTeleOpBlue2 extends LinearOpMode {
...
//set the motors to a useable mode
        ...
        while (opModeIsActive()) {
            ...
            double ledPower = (backleftPower + frontrightPower + backrightPower + frontleftPower) / 7;
            if (ledPower < 0) {
