...
@TeleOp(name="MecanumBareDriveCopy")
public class MecanumBareDrive_Copy extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.dpad_up && !(arm.getCurrentPosition()>=4200)){
                arm.setPower(-0.85);
                armTarget = arm.getCurrentPosition() + 90;
                arm.setTargetPosition(armTarget);
